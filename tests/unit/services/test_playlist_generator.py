...
class TestPlaylistGenerator(unittest.TestCase):
    def setUp(self):
        ...
        self.generator = PlaylistGenerator(
            self.config, self.mock_db, self.mock_similarity
        )
    ...
    def test_find_seed_songs(self):
        ...
        seeds = self.generator.find_seed_songs(
    ...
    def test_find_similar_songs(self):
        ...
        similar = self.generator.find_similar_songs(
    ...
    def test_sort_by_bpm(self):
        ...
        sorted_songs = self.generator.sort_by_bpm(
