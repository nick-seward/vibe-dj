...
class TestNavidromeSyncService:
    ...
    def test_sync_playlist_success_create_new(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_sync_playlist_success_update_existing(self, mock_client_class, service, mock_playlist):
        """Test successful playlist update on Navidrome."""
        mock_client = Mock(spec=NavidromeClient)
        mock_client_class.return_value = mock_client
        
        mock_client.search_song.side_effect = ['song_id_1', 'song_id_2', 'song_id_3']
        mock_client.get_playlist_by_name.return_value = {'id': 'existing_id', 'name': 'Test Playlist'}
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_sync_playlist_partial_match(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_credential_resolution_env_vars(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_credential_resolution_config(self, mock_client_class, service, mock_playlist):
        ...
        assert result['success'] is True
        mock_client_class.assert_called_once_with(
            'http://config-url:4533',
            'config_user',
            'config_pass'
        )
    
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_credential_resolution_priority_params_over_env(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_playlist_name_defaults_to_filename(self, mock_client_class, service, mock_playlist):
        ...
        result = service.sync_playlist(
            playlist=mock_playlist,
            output_path="/playlists/my_awesome_playlist.m3u"
        )
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_sync_playlist_update_failure(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_sync_playlist_create_failure(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_sync_playlist_client_exception(self, mock_client_class, service, mock_playlist):
    ...
    @patch('vibe_dj.services.navidrome_sync_service.NavidromeClient')
    def test_sync_playlist_partial_credentials(self, mock_client_class, service, mock_playlist):
