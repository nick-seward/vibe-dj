...
class TestMusicDatabase(unittest.TestCase):
    ...
    def test_add_song_with_features(self):
        ...
        np.testing.assert_array_almost_equal(
            retrieved_features.feature_vector,
            self.test_features.feature_vector
        )
    ...
    def test_find_songs_by_title(self):
        ...
        song2 = Song(
            ...
            genre="Rock", mbid=None, last_modified=0.0, duration=200
        )
        song3 = Song(
            id=0, file_path="/test/3.mp3", title="Pop Song", artist="Artist 3",
            genre="Pop", mbid=None, last_modified=0.0, duration=190
        )
    ...
    def test_get_all_songs_with_features(self):
        ...
        features2 = Features(
            song_id=0,
            feature_vector=np.array([3.0, 4.0], dtype=np.float32),
            bpm=130.0
        )
