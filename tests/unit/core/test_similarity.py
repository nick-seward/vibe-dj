...
def test_build_index(similarity_env):
...
def test_build_index_empty_vectors(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
...
def test_build_index_mismatched_lengths(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
...
def test_search(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    index.build_index(test_vectors, test_song_ids)
...
def test_search_without_index(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
...
def test_search_wrong_dimension(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    index.build_index(test_vectors, test_song_ids)
...
def test_save_and_load(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    index.build_index(test_vectors, test_song_ids)
    index.save()
...
def test_save_without_index(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    with pytest.raises(RuntimeError):
        index.save()


def test_add_vectors(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    index.build_index(test_vectors, test_song_ids)
...
def test_add_vectors_wrong_dimension(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    index.build_index(test_vectors, test_song_ids)
...
def test_remove_vectors(similarity_env):
    config, index, test_vectors, test_song_ids = similarity_env
    index.build_index(test_vectors, test_song_ids)
