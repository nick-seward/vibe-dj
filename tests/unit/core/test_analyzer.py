...
def test_extract_features_success(mock_librosa, analyzer):
...
@patch("vibe_dj.core.analyzer.librosa")
def test_extract_features_failure(mock_librosa, analyzer):
...
def test_extract_metadata_with_tags(mock_mutagen, analyzer):
...
@patch("vibe_dj.core.analyzer.MutagenFile")
def test_extract_metadata_missing_tags(mock_mutagen, analyzer):
...
@patch("vibe_dj.core.analyzer.MutagenFile")
def test_get_duration_success(mock_mutagen, analyzer):
...
@patch("vibe_dj.core.analyzer.MutagenFile")
def test_get_duration_failure(mock_mutagen, analyzer):
...
def test_analyze_file_success(
    mock_extract_features, mock_get_duration, mock_extract_metadata, analyzer
):
...
@patch.object(AudioAnalyzer, "extract_features")
def test_analyze_file_no_features(mock_extract_features, analyzer):
