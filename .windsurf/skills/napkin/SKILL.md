...
description: |
  ...
  napkin lives in the repo at `.windsurf/napkin.md`.
author: Codex
version: 5.0.0
date: 2026-02-06
github: https://github.com/blader/napkin
---
...
First thing, every session — read `.windsurf/napkin.md` before doing anything
else. Internalize what's there and apply it silently. Don't announce that you
read it. Just apply what you know.

If no napkin exists yet, create one at `.windsurf/napkin.md`:
