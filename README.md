...
[![CI](https://github.com/nick-seward/vibe-dj/actions/workflows/ci.yml/badge.svg)](https://github.com/nick-seward/vibe-dj/actions/workflows/ci.yml)
...
## Docker Compose
Pull the latest image to run Vibe-DJ locally.
